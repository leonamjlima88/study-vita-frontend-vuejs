      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header">
            <h4>
              Clientes
              <button @click="openCustomerCreateRoute()" class="btn btn-success float-end">
          ...
          <div class="card m-1" v-if="!isLoading">
              ...
              <div class="row">
                <div class="col-md-10 col-lg-11 mb-2">
                  <input
                    ...
                    @keyup.enter="getCustomerList(true)"
                    type="text"
                    class="form-control"
                ...
                <div class="col-md-2 col-lg-1 mb-2">
                  <button @click="getCustomerList(true)" class="btn btn-button btn-primary float-end">Pesquisar</button>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr v-for="currentCustomer in s_customerList.data" :key="currentCustomer.id">
                    <td>{{ currentCustomer.id }}</td>
                    <td>{{ currentCustomer.business_name }}</td>
                    <td class="text-center">
                      <div class="row"></div>
                      <a @click="openCustomerEditRoute(currentCustomer.id)" class="btn btn-button btn btn-outline-primary btn-sm mx-1">
                        <fa icon="pen"></fa>
                      </a>
                      <a @click="destroyCustomer(currentCustomer.id)" class="btn btn-button btn btn-outline-danger btn-sm mx-1">
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination justify-content-center">
                <!-- Primeira página -->
                <li :class="((pageConfig.current != 1) && (s_customerList.last_page > 0)) ? 'page-item' : 'page-item disabled'" >
                ...
                <!-- Próxima página -->
                <li :class="(pageConfig.current != s_customerList.last_page) ? 'page-item' : 'page-item disabled'" >
...
<style src="./CustomerList.css" scoped></style>
