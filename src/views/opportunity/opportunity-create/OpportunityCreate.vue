        ...
        <div class="card">
          <div class="card-header p-2">
            ...
            <div class="card-body p-2">
              <!-- INICIO DO form -->
              <form v-if="!this.isLoading && opportunity">
                <div class="row">
                  <!-- INICIO DO CAMPO customer_id -->
                  <div class="form-group mb-3 col-md-4">
                    <label>* Cliente</label>
                    <custom-select
                      v-model="v$.opportunity.customer_id.$model"
                      :items="s_customerList"
                      label="business_name"
                      placeholder="Selecione o cliente"
                    />
                    <div
                      v-if="v$.opportunity.customer_id.$errors.length"
                  ...
                  <div class="form-group mb-3 col-md-4">
                    ...
                    <custom-select
                      v-model="v$.opportunity.seller_id.$model"
                      :items="s_sellerList"
                      label="name"
                      placeholder="Selecione o vendedor"
                    />
                    <div
                      v-if="v$.opportunity.seller_id.$errors.length"
                      class="alert alert-danger d-flex align-items-center mt-2"
                      role="alert"
                    >
                      <div>* Campo obrigatório!</div>
                  ...
                  <div class="form-group mb-3 col-md-2">
                    <label>* Status</label>
                    <custom-select
                      v-model="v$.opportunity.status.$model"
                      :items="statusList"
                      label="name"
                      placeholder="Selecione o status"
                    />
                    <div v-if="v$.opportunity.status.$errors.length" class="alert alert-danger d-flex align-items-center mt-2" role="alert">
                      <div>* Campo obrigatório!</div>
                    </div>
                  </div>
                  <!-- FIM DO CAMPO status -->
                  ...
                  <div class="form-group mb-3 col-md-2">
                    <label>* Status</label>
                    <custom-select
                      v-model="v$.opportunity.approval.$model"
                      :items="approvalList"
                      label="name"
                      placeholder="Selecione a aprovação"
                    />
                    <div
                      v-if="v$.opportunity.approval.$errors.length"
                      class="alert alert-danger d-flex align-items-center mt-2"
                      role="alert"
                    >
                      <div>* Campo obrigatório!</div>
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <table v-if="opportunity.opportunity_product" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <tr v-for="item in opportunity.opportunity_product" :key="item.product_id">
                          <td>
                            {{ item.product.name }}
                    ...
                    <!-- FIM DA table opportunity_product -->
                  </div>
                  <div class="card-footer">
                    <div class="row">
                      <div class="col-6 text-start">
                        Volumes: {{ getOpportunityProductSum.saleQuantity }}
                      </div>
                      <div class="col-6 text-end">
                        Total: R$ {{ getOpportunityProductSum.saleAmout }}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group mb-3">
                  <button :disabled="v$.opportunity.$invalid" @click.prevent="submitAndClose()" class="btn btn-primary">
...
<script src="./OpportunityCreate.js"></script>
<style src="./OpportunityCreate.css" scoped></style>
